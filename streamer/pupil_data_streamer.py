...
while True :
    ...
    print json.dumps([{'id':p0_data['id'],'norm_pos':p0_data['norm_pos'],'confidence':p0_data['confidence'],'timestamp':p0_data['timestamp']},{'id':p1_data['id'],'norm_pos':p1_data['norm_pos'],'confidence':p1_data['confidence'],'timestamp':p1_data['timestamp']}])
